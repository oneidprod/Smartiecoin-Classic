/* src/config/smartiecoin-config.h.  Generated from smartiecoin-config.h.in by configure.  */
/* src/config/smartiecoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SMARITECOIN_CONFIG_H

#define SMARITECOIN_CONFIG_H
