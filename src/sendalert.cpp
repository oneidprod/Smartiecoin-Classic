...
2. run smartiecoind with -printalert or -sendalert like this:
   /path/to/smartiecoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    // alert.setSubVer.insert(std::string("/Smartiecoin Classic:0.12.0.58/"));
