    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("Smartiecoin Classic");
    QString versionText     = QString(tr("Version %1")).arg(QString::fromStdString(FormatFullVersion()));
    QString copyrightTextBtc   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Bitcoin Core developers"));
    QString copyrightTextDash   = QChar(0xA9)+QString(" 2014-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Dash Core developers"));
    QString copyrightTextSmartiecoin   = QChar(0xA9)+QString(" 2018-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Smartiecoin Classic developers"));
    ...
    pixPaint.setPen(QColor(38,73,33));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+16,copyrightTextDash);
	pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+32,copyrightTextSmartiecoin);
